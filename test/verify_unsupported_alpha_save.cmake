...
foreach(format RANGE 1 15)
  set(unsupported_save
      "${REPORT_DIR}/unsupported-alpha-save-${format}.json")
  file(WRITE "${unsupported_save}"
    "{\"application\":\"apsis-drift\",\"format_version\":${format}}\n")
  ...
  if(path_index EQUAL -1 OR reset_index EQUAL -1 OR
     untouched_index EQUAL -1 OR
     NOT before_checksum STREQUAL after_checksum)
    message(FATAL_ERROR
      "format ${format} diagnostic or source preservation failed:\n${error}")
  endif()
endforeach()
