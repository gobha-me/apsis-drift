...
auto deterministic_planetary_flight_replay() -> void {
  ...
  if (actual_checksum != expected_checksum) {
    std::fprintf(stderr,
                 "planetary replay checksums: direct=%llu 30fps=%llu 60fps=%llu golden=%llu\n",
                 static_cast<unsigned long long>(actual_checksum),
                 static_cast<unsigned long long>(at_30 ? planetary_flight_state_checksum(*at_30) : 0),
                 static_cast<unsigned long long>(at_60 ? planetary_flight_state_checksum(*at_60) : 0),
