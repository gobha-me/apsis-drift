...
[[nodiscard]] auto format_flight_instruments(const PlanetaryFlightState& state)
    -> FlightInstrumentReadout;
[[nodiscard]] auto format_flight_instruments(const SystemFlightState& state)
    -> FlightInstrumentReadout;
[[nodiscard]] auto format_flight_instruments(
    const OriginStationFlightState& state) -> FlightInstrumentReadout;
